...
-- Send Window Left
hs.hotkey.bind(mash, "Left", function() sizeup.send_window_left() end)
hs.hotkey.bind(mash, "Right", function() sizeup.send_window_right() end)
hs.hotkey.bind(mash, "Up", function() sizeup.send_window_up() end)
hs.hotkey.bind(mash, "Down", function() sizeup.send_window_down() end)

--- Quarter Screen Actions ---
-- Send Window Upper Left
hs.hotkey.bind(mashb, "Left", function() sizeup.send_window_upper_left() end)
hs.hotkey.bind(mashb, "Up", function() sizeup.send_window_upper_right() end)
hs.hotkey.bind(mashb, "Down", function() sizeup.send_window_lower_left() end)
hs.hotkey.bind(mashb, "Right", function() sizeup.send_window_lower_right() end)

--- Multiple Monitor Actions ---
-- Send Window Prev Monitor
hs.hotkey.bind(minimash, "Left", function() sizeup.send_window_prev_monitor() end)
hs.hotkey.bind(minimash, "Right", function() sizeup.send_window_next_monitor() end)
